...
class LoanCreateView(CreateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(LoanCreateView, self).dispatch(request, *args, **kwargs)

    def get(self, request, *args, **kwargs):
        return super(LoanCreateView, self).get(request, *args, **kwargs)

    def post(self, request, *args, **kwargs):
        return super(LoanCreateView, self).post(request, *args, **kwargs)

    def get_form_class(self):
        return super(LoanCreateView, self).get_form_class()

    def get_form(self, form_class):
        return super(LoanCreateView, self).get_form(form_class)

    def get_form_kwargs(self, **kwargs):
        return super(LoanCreateView, self).get_form_kwargs(**kwargs)

    def get_initial(self):
        return super(LoanCreateView, self).get_initial()

    def form_invalid(self, form):
        return super(LoanCreateView, self).form_invalid(form)
    ...
    def get_template_names(self):
        return super(LoanCreateView, self).get_template_names()
